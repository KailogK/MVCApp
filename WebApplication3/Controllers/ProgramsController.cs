...
namespace WebApplication3.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProgramName,Benefits,Charge")] Programme program)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ProgramName,Benefits,Charge")] Programme program)
        {
